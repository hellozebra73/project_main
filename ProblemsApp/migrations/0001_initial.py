    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('problem_name', models.CharField(blank=True, max_length=500, verbose_name='Problem name')),
                ('text', models.TextField(null=True)),
                ('template', models.CharField(default={}, max_length=500, verbose_name='Problem Template')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('problem_num_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ProblemsApp.ProblemNumeral', verbose_name='Problem Numeral ID')),
            ],
        ),
        migrations.CreateModel(
            name='Substep',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('substep_name', models.CharField(blank=True, max_length=500, verbose_name='Substep name')),
