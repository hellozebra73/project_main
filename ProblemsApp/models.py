...
class Problem(models.Model):
	...
	#This status will be set to True once the problem is complete - then it will be store in the problem data base. 
	#While the problems remains incomplete it will not 
